  ...
  return (
    <div style={{ paddingBottom:20 }}>
      ...
      <div style={{ display:'flex',flexDirection:'column',gap:10 }}>
        {SECTIONS.map(s=>(
          <div key={s.id} onClick={()=>onNavigate(s.id)} style={{
            display:'flex',alignItems:'center',gap:16,padding:'16px',
            ...G.card,
            cursor:'pointer',
            transition:'transform .15s',
            background:`linear-gradient(135deg,${s.color}14 0%,rgba(28,28,30,0.8) 100%)`,
          }}
...
Object.assign(window, { HabitosScreen, VidaScreen, MasHub, WeeklyReview });
